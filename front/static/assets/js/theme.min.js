...
,_init(){const t=this;for(let e=0;e<t.collection.length;e+=1){let i,o;t.collection[e].hasOwnProperty("$initializedEl")||(i=t.collection[e].options,o=t.collection[e].$el,t.collection[e].$initializedEl=new Dropzone(o,i))}}}
/*
* HSSortable Plugin
...
,_init:function(){const t=this;for(let e=0;e<t.collection.length;e+=1){let i;if(t.collection[e].hasOwnProperty("$initializedEl"))continue;i=t.collection[e];const o=Object.assign({},{selector:i.$el},i.options);t.collection[e].$initializedEl=new jsVectorMap(o),window.addEventListener("resize",(()=>{t.collection[e].$initializedEl.updateSize()}))}}},
/*
* Chart.js wrapper
